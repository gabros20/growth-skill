...
export const themes = {
  light: {
    ...
    line: "#d8dde8",
    accent: "#65a30d",
    accentInk: "#132b06", // lime is high-luminance even at full saturation — dark ink, not white, is the readable pairing
    amber: "#a97a10",
    amberBg: "#fdf6e3",
    good: "#1e7f4f",
    bad: "#b3403a",
    codeBg: "#eef1f7",
    glyph: "#8391ad",
    dim: "#8146c9", // the "additive overlay" violet (--tok-dim) — shared family convention, not accent-tied
    wire: "#e7eaf1",
  },
  dark: {
    bg: "#12151d",
